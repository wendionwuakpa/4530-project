<!DOCTYPE html><html class="minimal no-js"><head>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge">
	<title>@twilio/conversations | @twilio/conversations</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-interface">
			<a href="interfaces/ConversationUpdatedEventArgs.html" class="tsd-kind-icon">Conversation<wbr>Updated<wbr>Event<wbr>Args</a>
		</li>
		<li class=" tsd-kind-interface">
...
<div class="container container-main">
	<div class="content-wrap">
		<div class="tsd-panel tsd-typography">
			<a href="#twilio-conversations-client-library" id="twilio-conversations-client-library" style="color: inherit; text-decoration: none;">
				<h1>Twilio Conversations client library</h1>
			</a>
			<p>Twilio Conversations: Create meaningful connections with customers across various communication channels.
			Visit our official site for more detalis: <a href="https://www.twilio.com/conversations">https://www.twilio.com/conversations</a></p>
...
<span style="color: #000000">});</span>
			...
			<pre><code class="language-html"><span style="color: #800000">&lt;script</span><span style="color: #000000FF"> </span><span style="color: #FF0000">src</span><span style="color: #000000FF">=</span><span style="color: #0000FF">"https://media.twiliocdn.com/sdk/js/conversations/v2.4/twilio-conversations.min.js"</span><span style="color: #800000">&gt;&lt;/script&gt;</span>
</code></pre>
			...
			<p>The CDN consumption described above allows you to consume latest bug fixed versions automatically,
			but does not prevent from detecting malicious modifications in the SDK code.</p>
...
<span style="color: #000000FF">  </span><span style="color: #FF0000">src</span><span style="color: #000000FF">=</span><span style="color: #0000FF">"https://media.twiliocdn.com/sdk/js/conversations/releases/2.4.0/twilio-conversations.min.js"</span>
...
<span style="color: #800000">&gt;&lt;/script&gt;</span>
				...
				<div class="tsd-index-content">
					...
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							...
							<li class="tsd-kind-interface"><a href="interfaces/ConversationUpdatedEventArgs.html" class="tsd-kind-icon">Conversation<wbr>Updated<wbr>Event<wbr>Args</a></li>
							...
							<li class="tsd-kind-interface"><a href="interfaces/ParticipantBindings.html" class="tsd-kind-icon">Participant<wbr>Bindings</a></li>
							<li class="tsd-kind-interface"><a href="interfaces/ParticipantEmailBinding.html" class="tsd-kind-icon">Participant<wbr>Email<wbr>Binding</a></li>
					...
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							...
							<li class="tsd-kind-type-alias"><a href="modules.html#NotificationsChannelType" class="tsd-kind-icon">Notifications<wbr>Channel<wbr>Type</a></li>
							<li class="tsd-kind-type-alias"><a href="modules.html#ParticipantEmailLevel" class="tsd-kind-icon">Participant<wbr>Email<wbr>Level</a></li>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">Connection<wbr>State<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">TwilsockConnectionState</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Connection state of the client. Possible values are as follows:</p>
						<ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">Conversation<wbr>Status<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"notParticipating"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"joined"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Status of the conversation, relative to the client: whether the conversation
						has been <code>joined</code> or the client is <code>notParticipating</code> in the conversation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ConversationUpdateReason" class="tsd-anchor"></a>
				<h3>Conversation<wbr>Update<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">Conversation<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"createdBy"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"friendlyName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastReadMessageIndex"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"state"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"status"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"uniqueName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastMessage"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"notificationLevel"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"bindings"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Reason for the <code>updated</code> event emission by a conversation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="DeliveryAmount" class="tsd-anchor"></a>
				<h3>Delivery<wbr>Amount</h3>
				<div class="tsd-signature tsd-kind-icon">Delivery<wbr>Amount<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"none"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"some"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"all"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Signifies the amount of participants which have the status for the message.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="DeliveryStatus" class="tsd-anchor"></a>
				<h3>Delivery<wbr>Status</h3>
				<div class="tsd-signature tsd-kind-icon">Delivery<wbr>Status<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"sent"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"delivered"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"failed"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"read"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"undelivered"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"queued"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">Message<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"text"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"media"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="MessageUpdateReason" class="tsd-anchor"></a>
				<h3>Message<wbr>Update<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">Message<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"body"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastUpdatedBy"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"author"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"deliveryReceipt"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"subject"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The reason for the <code>updated</code> event being emitted by a message.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">Notification<wbr>Level<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"default"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"muted"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>User's notification level for the conversation. Determines
							whether the currently logged-in user will receive pushes for events
							in this conversation. Can be either <code>muted</code> or <code>default</code>, where
						<code>default</code> defers to the global service push configuration.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="NotificationsChannelType" class="tsd-anchor"></a>
				<h3>Notifications<wbr>Channel<wbr>Type</h3>
				<div class="tsd-signature tsd-kind-icon">Notifications<wbr>Channel<wbr>Type<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">ChannelType</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Notifications channel type. Possible values are as follows:</p>
						<ul>
							<li><code>'fcm'</code></li>
							<li><code>'apn'</code></li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ParticipantEmailLevel" class="tsd-anchor"></a>
				<h3>Participant<wbr>Email<wbr>Level</h3>
				<div class="tsd-signature tsd-kind-icon">Participant<wbr>Email<wbr>Level<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"to"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"cc"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Email participation level.
							to = to/from
						cc = cc</p>
					</div>
				</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				<a name="ParticipantUpdateReason" class="tsd-anchor"></a>
				<h3>Participant<wbr>Update<wbr>Reason</h3>
				<div class="tsd-signature tsd-kind-icon">Participant<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateCreated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"dateUpdated"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"roleSid"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastReadMessageIndex"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"lastReadTimestamp"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"bindings"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The reason for the <code>updated</code> event being emitted by a participant.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
			...
			<section class="tsd-panel tsd-member tsd-kind-type-alias">
				...
				<div class="tsd-signature tsd-kind-icon">User<wbr>Update<wbr>Reason<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">"friendlyName"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"attributes"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"reachabilityOnline"</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">"reachabilityNotifiable"</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The reason for the <code>updated</code> event being emitted by a user.</p>
					</div>
				</div>
			</section>
		</section>
