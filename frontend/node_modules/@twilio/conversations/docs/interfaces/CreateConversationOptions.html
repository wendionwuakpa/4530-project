...
<head>
	...
	<title>CreateConversationOptions | @twilio/conversations</title>
	...
	<ul>
		<li class="current tsd-kind-interface">
			...
			<ul>
				...
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="CreateConversationOptions.html#friendlyName" class="tsd-kind-icon">friendly<wbr>Name</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="CreateConversationOptions.html#uniqueName" class="tsd-kind-icon">unique<wbr>Name</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Options for <a href="../classes/Client.html#createConversation">Client.createConversation</a>.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">CreateConversationOptions</span>
				</li>
			</ul>
		</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">attributes<span class="tsd-signature-symbol">:</span> <a href="../modules.html#JSONValue" class="tsd-signature-type" data-tsd-kind="Type alias">JSONValue</a></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Any custom attributes to attach to the conversation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="friendlyName" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> friendly<wbr>Name</h3>
				...
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A non-unique display name of the conversation.</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="uniqueName" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> unique<wbr>Name</h3>
				<div class="tsd-signature tsd-kind-icon">unique<wbr>Name<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>A unique identifier of the conversation.</p>
					</div>
				</div>
			</section>
		</section>
