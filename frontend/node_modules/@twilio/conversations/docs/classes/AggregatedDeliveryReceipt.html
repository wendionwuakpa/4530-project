...
<head>
	...
	<title>AggregatedDeliveryReceipt | @twilio/conversations</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#delivered" class="tsd-kind-icon">delivered</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#failed" class="tsd-kind-icon">failed</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#read" class="tsd-kind-icon">read</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#sent" class="tsd-kind-icon">sent</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#total" class="tsd-kind-icon">total</a>
				</li>
				<li class=" tsd-kind-get-signature tsd-parent-kind-class">
					<a href="AggregatedDeliveryReceipt.html#undelivered" class="tsd-kind-icon">undelivered</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Contains aggregated information about delivery statuses of a message across all participants
					of a conversation.</p>
				</div>
				<p>At any moment during the message delivery to a participant, the message can have zero or more of the following
				delivery statuses:</p>
				<ul>
					<li>Message is considered as <strong>sent</strong> to a participant if the nearest upstream carrier accepted the message.</li>
					<li>Message is considered as <strong>delivered</strong> to a participant if Twilio has received confirmation of message
					delivery from the upstream carrier, and, where available, the destination handset.</li>
					<li>Message considered as <strong>undelivered</strong> to a participant if Twilio has received a delivery receipt
						indicating that the message was not delivered. This can happen for many reasons including carrier content
					filtering and the availability of the destination handset.</li>
					<li>Message considered as <strong>read</strong> by a participant if the message has been delivered and opened by the
					recipient in a conversation. The recipient must have enabled the read receipts.</li>
					<li>Message considered as <strong>failed</strong> to be delivered to a participant if the message could not be sent.
						This can happen for various reasons including queue overflows, account suspensions and media
					errors (in the case of MMS for instance).</li>
				</ul>
				<p><a href="AggregatedDeliveryReceipt.html">AggregatedDeliveryReceipt</a> class contains an aggregated value <a href="../modules.html#DeliveryAmount">DeliveryAmount</a> for each delivery status.</p>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">AggregatedDeliveryReceipt</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#delivered" class="tsd-kind-icon">delivered</a></li>
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#failed" class="tsd-kind-icon">failed</a></li>
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#read" class="tsd-kind-icon">read</a></li>
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#sent" class="tsd-kind-icon">sent</a></li>
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#total" class="tsd-kind-icon">total</a></li>
							<li class="tsd-kind-get-signature tsd-parent-kind-class"><a href="AggregatedDeliveryReceipt.html#undelivered" class="tsd-kind-icon">undelivered</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				<a name="delivered" class="tsd-anchor"></a>
				<h3>delivered</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> delivered<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Message is considered as <strong>delivered</strong> to a participant if Twilio has received confirmation of message
								delivery from the upstream carrier, and, where available, the destination handset.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></h4>
						<p>Amount of participants that have the <strong>delivered</strong> delivery status for the message.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				...
				<h3>failed</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> failed<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Message is considered as <strong>failed</strong> to be delivered to a participant if the message could not be sent.
									This can happen for various reasons including queue overflows, account suspensions and media
								errors (in the case of MMS for instance). Twilio does not charge you for failed messages.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></h4>
						<p>Amount of participants that have the <strong>failed</strong> delivery status for the message.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				...
				<h3>read</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> read<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Message is considered as <strong>read</strong> by a participant, if the message has been delivered and opened by the
								recipient in a conversation. The recipient must have enabled the read receipts.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></h4>
						<p>Amount of participants that have the <strong>read</strong> delivery status for the message.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				<a name="sent" class="tsd-anchor"></a>
				<h3>sent</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> sent<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Message is considered as <strong>sent</strong> to a participant if the nearest upstream carrier accepted the message.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></h4>
						<p>Amount of participants that have the <strong>sent</strong> delivery status for the message.</p>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				...
				<h3>total</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> total<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">number</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Maximum number of delivery events expected for the message.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-get-signature tsd-parent-kind-class">
				<a name="undelivered" class="tsd-anchor"></a>
				<h3>undelivered</h3>
				<ul class="tsd-signatures tsd-kind-get-signature tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon"><span class="tsd-signature-symbol">get</span> undelivered<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
						...
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Message is considered as <strong>undelivered</strong> to a participant if Twilio has received a delivery receipt
									indicating that the message was not delivered. This can happen for many reasons including carrier content
								filtering and the availability of the destination handset.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../modules.html#DeliveryAmount" class="tsd-signature-type" data-tsd-kind="Type alias">DeliveryAmount</a></h4>
						<p>Ammount of participants that have the <strong>undelivered</strong> delivery status for the message.</p>
					</li>
				</ul>
			</section>
		</section>
