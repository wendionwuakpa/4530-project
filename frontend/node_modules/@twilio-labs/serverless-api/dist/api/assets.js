...
exports.uploadAsset = exports.getOrCreateAssetResources = exports.listAssetResources = void 0;
...
function createAssetResource(name, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield client.request('post', `Services/${serviceSid}/Assets`, {
                form: {
                    FriendlyName: name,
                },
            });
 ...
 */
function createAssetVersion(asset, serviceSid, client, clientConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const contentType = yield content_type_1.getContentType(asset.content, asset.filePath || asset.name);
            ...
            const resp = yield client.request('post', `Services/${serviceSid}/Assets/${asset.sid}/Versions`, {
                responseType: 'text',
                prefixUrl: api_client_1.getApiUrl(clientConfig, 'serverless-upload'),
                body: form,
            });
 ...
 * @returns {Promise<Sid>}
 */
function uploadAsset(asset, serviceSid, client, clientConfig) {
    return __awaiter(this, void 0, void 0, function* () {
        const version = yield createAssetVersion(asset, serviceSid, client, clientConfig);
        return version.sid;
    });
}
