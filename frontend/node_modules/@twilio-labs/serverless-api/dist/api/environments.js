...
function getEnvironment(environmentSid, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield client.request('get', `Services/${serviceSid}/Environments/${environmentSid}`);
        return resp.body;
    });
}
...
function createEnvironmentFromSuffix(domainSuffix, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const resp = yield client.request('post', `Services/${serviceSid}/Environments`, { form });
        return resp.body;
    });
}
