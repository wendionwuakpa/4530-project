...
exports.activateBuild = exports.waitForSuccessfulBuild = exports.triggerBuild = exports.listBuilds = exports.getBuild = void 0;
...
function getBuild(buildSid, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        const resp = yield client.request('get', `Services/${serviceSid}/Builds/${buildSid}`);
        return resp.body;
    });
}
...
function triggerBuild(config, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const resp = yield client.request('post', `Services/${serviceSid}/Builds`, {
                responseType: 'json',
                headers: {
...
function activateBuild(buildSid, environmentSid, serviceSid, client) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const resp = yield client.request('post', `Services/${serviceSid}/Environments/${environmentSid}/Deployments`, {
                form: {
                    BuildSid: buildSid,
                },
            });
