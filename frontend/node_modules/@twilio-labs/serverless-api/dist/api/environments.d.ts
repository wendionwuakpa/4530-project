...
import { EnvironmentResource, Sid } from '../types';
 ...
 */
export declare function getEnvironment(environmentSid: Sid, serviceSid: Sid, client: TwilioServerlessApiClient): Promise<EnvironmentResource>;
/**
 ...
 * @returns {Promise<EnvironmentResource>}
 */
export declare function createEnvironmentFromSuffix(domainSuffix: string, serviceSid: string, client: TwilioServerlessApiClient): Promise<EnvironmentResource>;
/**
 ...
 * @returns
 */
export declare function listEnvironments(serviceSid: string, client: TwilioServerlessApiClient): Promise<EnvironmentResource[]>;
/**
 ...
 * @returns {Promise<EnvironmentResource>}
 */
export declare function getEnvironmentFromSuffix(domainSuffix: string, serviceSid: string, client: TwilioServerlessApiClient): Promise<EnvironmentResource>;
/**
 ...
 * @returns
 */
export declare function createEnvironmentIfNotExists(domainSuffix: string, serviceSid: string, client: TwilioServerlessApiClient): Promise<EnvironmentResource>;
