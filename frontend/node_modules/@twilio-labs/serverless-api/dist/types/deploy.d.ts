...
import { AssetResource, EnvironmentVariables, ServerlessResourceConfig, FunctionResource } from './generic';
import { Sid } from './serverless-api';
/**
 * Shared configuration of Deploy functions
 */
declare type DeployProjectConfigBase = {
    /**
 ...
 */
export declare type DeployProjectConfig = ClientConfig & DeployProjectConfigBase & {
    /**
 ...
 */
export declare type DeployLocalProjectConfig = ClientConfig & DeployProjectConfigBase & {
    /**
...
export declare type StatusUpdate = {
    status: DeployStatus;
    message: string;
};
export declare type StatusUpdateCallback = (update: StatusUpdate) => void;
export {};
