...
export declare type AccountSidConfig = BaseClientConfig & {
    /**
...
export declare type UsernameConfig = BaseClientConfig & {
    /**
     * Twilio AccountSID or API Key
     */
    username: string;
 ...
 */
export declare type ClientConfig = AccountSidConfig | UsernameConfig;
export {};
